...
\draw[draw=black, line width=0.02cm, rounded corners=0.05cm] (start) to (b);
\draw[draw=black, line width=0.02cm, rounded corners=0.05cm] (b) to (end);
\draw[draw=black, line width=0.02cm, rounded corners=0.05cm] (start.south) to (end);
