...
/**
 * Script to update column headers in edge CSV files from old format to new format
 * Specifically targeting the rename of columns to startAnchor and endAnchor
 */
...
function main() {
  ...
  if (options.help) {
    console.log(`
Usage: node rename_edge_csv_columns.js [options] <path>
